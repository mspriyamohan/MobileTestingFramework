...
public class calculator {
		...
		public static void main(String[] args) throws MalformedURLException {
			...
			uia.setCapability("appPackage","com.sec.android.app.popupcalculator");
			uia.setCapability("appActivity","com.sec.android.app.popupcalculator.Calculator");
			...
			Point tapPoint=new Point(420,1669);
